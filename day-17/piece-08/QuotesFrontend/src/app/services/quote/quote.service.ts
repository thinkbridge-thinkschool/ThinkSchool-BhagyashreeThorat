...
// lives as signals in the components.
...
export class QuoteService {
  ...
  // GET /api/quotes?page=1&size=50[&search=term]  -> Quote[]
  // `search` is optional; when provided the backend filters by text/author/id.
  // Paging still applies, so results respect page/size.
  ...
  // POST /api/quotes  body { author, text } -> Quote  (JWT-protected)
