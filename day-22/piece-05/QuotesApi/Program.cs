...
try
{
    ...
    builder.Services.AddHostedService<AnalyticsSubscriptionWorker>();
    //builder.Services.AddHostedService<AnalyticsSubscriptionWorker2>();
    ...
    async (ServiceBusPublisher publisher) =>
    {
        ...
        return Results.Ok("Poison message published");
    });
